---
title: "Gradient accumulation and KoLeo loss - Part 3/3"
date: 2026-01-05T19:53:33+05:30
draft: false
...
>    0.weight <br/>
>    ---------- <br/>
>    [[ 0.5406104   0.5869042 ] <br/>
>     [-0.16565566  0.6495563 ] <br/>
>     [-0.15492962  0.14268756]] <br/>
>    1.weight <br/>
>    ---------- <br/>
>    [[-0.28108588  0.3390678   0.50895905]] <br/>
</div>
...
<span style="color: black; background-color:#f5f5f5; padding:0.1em 0.2em; font-family:'Courier New', monospace;">> 0.5844024419784546 <br/></span>
...
<div style="color: black; background-color:#f5f5f5; padding:0.1em 0.2em; font-family:'Courier New', monospace;">
> loss for sub-batch 0: 0.5325143933296204 <br/>
> loss for sub-batch 1: 0.5711992383003235 <br/>
> loss for sub-batch 2: 0.7103754281997681 <br/>
> loss for sub-batch 3: 0.5235207676887512 <br/>
> mean loss: 0.5844024419784546 <br/>
</div>
...
<span style="color: black; background-color:#f5f5f5; padding:0.1em 0.2em; font-family:'Courier New', monospace;">> 2.3376097679138184 <br/></span>
...
<div style="color: black; background-color:#f5f5f5; padding:0.1em 0.2em; font-family:'Courier New', monospace;">
> Gradients of the model without gradient accumulation: <br/>
> 0.weight <br/>
> ---------- <br/>
> tensor([[-0.1107, -0.0319], <br/>
>         [ 0.1335,  0.0385], <br/>
>         [ 0.2004,  0.0578]]) <br/>
> 1.weight <br/>
> ---------- <br/>
> tensor([[ 0.2796,  0.0086, -0.0448]]) <br/>
> ==================== <br/>
> Gradients of the model with gradient accumulation: <br/>
> 0.weight <br/>
> ---------- <br/>
> tensor([[-0.4428, -0.1278], <br/>
>         [ 0.5342,  0.1541], <br/>
>         [ 0.8018,  0.2314]]) <br/>
> 1.weight <br/>
> ---------- <br/>
> tensor([[ 1.1185,  0.0343, -0.1792]]) <br/>
</div>
...
<div style="color: black; background-color:#f5f5f5; padding:0.1em 0.2em; font-family:'Courier New', monospace;">
> Weights of the model without gradient accumulation: <br/>
> 0.weight <br/>
> ---------- <br/>
> [[ 0.65131354  0.61885107] <br/>
>  [-0.2991945   0.6110195 ] <br/>
>  [-0.35537863  0.0848418 ]] <br/>
> 1.weight <br/>
> ---------- <br/>
> [[-0.56070507  0.33048445  0.5537596 ]] <br/>
> Weights of the model with gradient accumulation: <br/>
> 0.weight <br/>
> ---------- <br/>
> [[ 0.65131354  0.61885107] <br/>
>  [-0.2991945   0.6110195 ] <br/>
...
$$ \mathcal{L}\_{\text{BCE}} = \frac{1}{N} \sum\_{i=1}^N \ell\_{\text{BCE}}(\hat{y}\_i, y\_i) $$
...
$$
\frac{1}{K} \sum\_{k=1}^K  \sum\_{i \in \text{sub-batch}\_k}^B \frac{1}{B} \ell\_{\text{BCE}}(\hat{y}\_i, y\_i) = \frac{1}{N}\sum\_{i=1}^{N} \ell\_{\text{BCE}}(\hat{y}\_i, y\_i)
$$
...
$$
\frac{1}{K} \sum\_{k=1}^K ( \frac{1}{B} \sum\_{(i,j) \in \text{sub-batch}\_k^2} -\log\left( \min\_{j \ne i} \| f(x\_i) - f(x\_j) \| \right)) \neq \frac{1}{N}\sum\_{i=1}^{N} -\log\left( \min\_{j \ne i} \| f(x\_i) - f(x\_j) \| \right))
$$
...
<div style="color: black; background-color:#f5f5f5; padding:0.1em 0.2em; font-family:'Courier New', monospace;">
> Loss without gradient accumulation: <br/>
> 4.714231491088867 <br/>
> Loss with gradient accumulation: <br/>
> 3.278782844543457 <br/>
</div>
...
<div style="color: black; background-color:#f5f5f5; padding:0.1em 0.2em; font-family:'Courier New', monospace; max-height: 400px; overflow-y: auto;">
> Before training <br/>
...
> 100it [02:19,  1.37s/it] <br/>
> Batch 100: Loss = 0.2881 <br/>
> 200it [04:39,  1.36s/it] <br/>
> Batch 200: Loss = 0.2516 <br/>
> 300it [06:55,  1.33s/it] <br/>
> Batch 300: Loss = 0.2195 <br/>
> 372it [08:32,  1.38s/it] <br/>
> Epoch 1 - train_loss: 0.2452, val_loss: 0.2162, val_auc: 0.8650 <br/>
> Validation metrics — val_loss: 0.2162, simple_loss: 0.1362, val_auc: 0.8650, mean_positive_similarities: 0.5532, mean_negative_similarities: 0.0585, mean_positive_euclidean_distances: 0.9000, mean_negative_euclidean_distances: 1.3458, good_triplets_ratio: 0.8624 <br/>
> New best AUC: 0.8650 at epoch 1 <br/>
> 100it [02:14,  1.34s/it] <br/>
> Batch 100: Loss = 0.1977 <br/>
> 200it [04:28,  1.31s/it] <br/>
> Batch 200: Loss = 0.1752 <br/>
> 300it [06:41,  1.33s/it] <br/>
> Batch 300: Loss = 0.1850 <br/>
> 372it [08:15,  1.33s/it] <br/>
> Epoch 2 - train_loss: 0.1849, val_loss: 0.2147, val_auc: 0.8691 <br/>
> Validation metrics — val_loss: 0.2147, simple_loss: 0.1360, val_auc: 0.8691, mean_positive_similarities: 0.5653, mean_negative_similarities: 0.0641, mean_positive_euclidean_distances: 0.8868, mean_negative_euclidean_distances: 1.3418, good_triplets_ratio: 0.8560 <br/>
> New best AUC: 0.8691 at epoch 2 <br/>
> 100it [02:13,  1.32s/it] <br/>
> Batch 100: Loss = 0.1640 <br/>
> 200it [04:21,  1.23s/it] <br/>
> Batch 200: Loss = 0.1593 <br/>
> 300it [06:26,  1.23s/it] <br/>
> Batch 300: Loss = 0.1512 <br/>
> 372it [07:54,  1.28s/it] <br/>
> ... <br/>
> 100it [02:02,  1.21s/it] <br/>
> Batch 100: Loss = 0.0618 <br/>
> 200it [04:04,  1.21s/it] <br/>
> Batch 200: Loss = 0.0607 <br/>
> 300it [06:06,  1.21s/it] <br/>
> Batch 300: Loss = 0.0669 <br/>
> 372it [07:32,  1.22s/it] <br/>
> Epoch 15 - train_loss: 0.0638, val_loss: 0.1205, val_auc: 0.9486 <br/>
> Validation metrics — val_loss: 0.1205, simple_loss: 0.0729, val_auc: 0.9486, mean_positive_similarities: 0.5120, mean_negative_similarities: -0.0241, mean_positive_euclidean_distances: 0.9680, mean_negative_euclidean_distances: 1.4218, good_triplets_ratio: 0.9416 <br/>
> New best AUC: 0.9486 at epoch 15 <br/>
</div>
...
<span style="color: black; background-color:#f5f5f5; padding:0.1em 0.2em; font-family:'Courier New', monospace;">> Combined plot saved at runs_koleo_gradacc/20251230_131112/distance_matrix_and_embeddings_gradacc.png <br/></span>
...
<div style="color: black; background-color:#f5f5f5; padding:0.1em 0.2em; font-family:'Courier New', monospace;">
> Intra-class distance: mean=0.4854, std=0.0488 <br/>
> Inter-class distance: mean=1.0279, std=0.1357 <br/>
> Separation margin: 0.5425 <br/>
</div>
...
<div style="display: flex; gap: 10px;">
  <img src="/images/distance_matrix_heatmap_part1.png" alt="Image 1" style="width: 50%;"/>
  <img src="/images/embeddings_2d_normalized_part2.png" alt="Image 2" style="width: 50%;"/>
</div>
...
<span style="color: black; background-color:#f5f5f5; padding:0.1em 0.2em; font-family:'Courier New', monospace;">> (24320, 3, 32, 32, 3) <br/></span>
...
> Fold 1/5 <br/>
> ================================================== <br/>
> Training WITHOUT gradient accumulation... <br/>
> <br/>
> 100%|█████████████████████████████████████████████████████████████████████████████████████████████████████████████████| 7/7 [05:55<00:00, 50.82s/it] <br/>
> <br/>
>   Best AUC: 0.9135 <br/>
> Training WITH gradient accumulation... <br/>
> <br/>
> 100%|█████████████████████████████████████████████████████████████████████████████████████████████████████████████████| 7/7 [04:03<00:00, 34.83s/it] <br/>
> <br/>
>   Best AUC: 0.9149 <br/>
> Fold 1 done. <br/>
> ... <br/>
...
> <br/>
> <br/>
> 100%|█████████████████████████████████████████████████████████████████████████████████████████████████████████████████| 7/7 [05:50<00:00, 50.04s/it] <br/>
> <br/>
> <br/>
>   Best AUC: 0.9215 <br/>
> Training WITH gradient accumulation... <br/>
> <br/>
> <br/>
> 100%|█████████████████████████████████████████████████████████████████████████████████████████████████████████████████| 7/7 [04:36<00:00, 39.54s/it] <br/>
> <br/>
> <br/>
>   Best AUC: 0.9111 <br/>
> Fold 5 done. <br/>
...
> AUC SCORES <br/>
> ====================================================================== <br/>
> Without gradient accumulation: 0.9193 +/- 0.0037 <br/>
> With gradient accumulation: 0.9177 +/- 0.0056 <br/>
> <br/>
> ====================================================================== <br/>
> ELLIPSE AREAS <br/>
> ====================================================================== <br/>
...
> ---------------------------------------------------------------------- <br/>
> cat          | 0.2119 +/- 0.0773        | 0.2169 +/- 0.0473 <br/>
> dog          | 0.1369 +/- 0.0475        | 0.1217 +/- 0.0358 <br/>
> horse        | 0.1474 +/- 0.0399        | 0.1438 +/- 0.0415 <br/>
> ship         | 0.0944 +/- 0.0272        | 0.0856 +/- 0.0233 <br/>
> <br/>
> ====================================================================== <br/>
> Average area across all classes: <br/>
>   Without gradient accumulation: 0.1479 +/- 0.0633 <br/>
>   With gradient accumulation: 0.1464 +/- 0.0581 <br/>
</div>
...
This series has explored siamese networks trained with triplet loss and KoLeo regularization, examining both the theoretical foundations and practical implications of batch-dependent losses.

We began by establishing a baseline (Chapter 1), training a Siamese network with triplet loss alone on CIFAR-10. The model learned to separate classes in the embedding space with good discrimination quality and clear visual separation, as shown in distance matrices and PCA projections, though embeddings formed compact intra-class clusters.

Building on this foundation, we introduced the KoLeo loss as a regularization technique to encourage a more uniform distribution of embeddings (Chapter 2). Through K-Fold cross-validation, we confirmed that the KoLeo loss achieves its objective: embeddings spread more uniformly in the representation space, with ellipse areas increasing. We also investigated the effect of the KoLeo loss weight parameter, revealing a clear trade-off between embedding spread and discrimination quality.

Finally, we addressed a critical practical concern: the impact of gradient accumulation on the batch-dependent KoLeo loss (Chapter 3). While gradient accumulation fundamentally changes how the KoLeo loss is computed—processing sub-batches independently rather than considering the full batch—we demonstrated through K-Fold validation that the practical impact is negligible. Both AUC scores and embedding distributions remain essentially unchanged when using gradient accumulation, validating its use in memory-constrained scenarios.

Together, these three chapters provide a complete picture of how to effectively use the KoLeo loss in practice. The loss successfully spreads embeddings while maintaining discrimination quality, and it can be safely combined with gradient accumulation when needed. Although the batch-dependent nature of the loss is theoretically important, it does not prevent its practical application in real-world training scenarios.
